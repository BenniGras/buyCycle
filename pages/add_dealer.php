...
<html>
<head>
    <title>byeCycle - Registrieren_Händler</title>
...
<form action="" method="post" id="form">
    ...
    <?php if(!empty($error)): ?>
        <div >
            ...
            <div class="form-control error">
                <input type="text" name="email" id="email" placeholder="E-Mail-Adresse" style="width:585px"> 
    ...
    <div>
        ...
        <div class="form-control">
            <input type="text" name="companyname" id="companyname" placeholder="Firmenname" style="width:585px"> 
            <i class="fa fa-check-circle fa-2x"></i>
            <i class="fa fa-exclamation-circle fa-2x"></i>
            <small>Error message</small>
        </div>
    ...
    <div>
        ...
        <div style="display: flex;justify-content:space-between;width:600px;">
            <div class="form-control" style="width:69%;">
                <input type="text" name="street" id="street" placeholder="Straße" style="width:96%;">
                <i class="fa fa-check-circle fa-2x"></i>
                <i class="fa fa-exclamation-circle fa-2x"></i>
                <small>Error message</small>
            </div>
            ...
            <div class="form-control" style="width:29%;">
                <input type="text" name="number" id="number" placeholder="Hausnummer" style="width:92%;">
                <i class="fa fa-check-circle fa-2x"></i>
                <i class="fa fa-exclamation-circle fa-2x"></i>
                <small>Error message</small>
            </div>
    ...
    <div>
        <label>Postleitzahl / Stadt *</label><br />
        <div style="display: flex;justify-content:space-between;width:600px;">
            <div class="form-control" style="width:29%;">
                <input type="number" name="zipcode" id="zipcode" placeholder="Postleitzahl" style="width:92%;">
                <i class="fa fa-check-circle fa-2x"></i>
                <i class="fa fa-exclamation-circle fa-2x"></i>
                <small>Error message</small>
            </div>
            ...
            <div class="form-control" style="width:69%;">
                <input type="text" name="city" id="city" placeholder="Stadt" style="width:96%;">
                <i class="fa fa-check-circle fa-2x"></i>
                <i class="fa fa-exclamation-circle fa-2x"></i>
                <small>Error message</small>
            </div>
...
<script type="text/javascript" src="../../JS/add_dealer.js"></script>
