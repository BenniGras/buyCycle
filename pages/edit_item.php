...
<div style="display: flex;align-items: space-between;">
    ...
    <div class="nav">
        ...
        <div class="nav_links">
            ...
            <a href="meine_daten">Meine Daten</a>
            <a href="meine_anzeigen" style="background-color: #00cc00;color: white;">Meine Anzeigen</a>
    ...
    <!--Details-->
        ...
        <label style="display:inline-block;">Kategorie<br />
            <select name="category" style="width: 297px">
                <option><?php echo e($item->category) ?></option>
                <option>-------------------------------------</option>
        ...
        <label style="display:inline-block;margin-left:15px;">Unterkategorie<br />
            <select name="subcategory" class="m">
                <option><?php echo e($item->subcategory) ?></option>
                <option>-----------------------------------</option>
        ...
        <label style="display:inline-block;">Marke<br />
            <select name="brand" style="width: 297px">
                <option><?php echo e($item->brand) ?></option>
                <option>-------------------------------------</option>
                <option>	3T	</option>
                <option>	A2B	</option>
        ...
        <label style="display:inline-block;margin-left:15px;">Modell<br />
            <select name="model" class="m">
                <option><?php echo e($item->model) ?></option>
                <option>-----------------------------------</option>
        ...
        <label style="display:inline-block;">Geschlecht<br />
            <select name="sex" style="width: 297px">
                <option><?php echo e($item->sex) ?></option>
                <option>-------------------------------------</option>
                <option>Damen</option>
        ...
        <label style="display:inline-block;margin-left:15px;">Gänge<br />
            <select name="gear" class="m">
                <option><?php echo e($item->gear) ?></option>
                <option>-----------------------------------</option>
                <option>1</option>
                <option>2</option>
                <option>3</option>
        ...
        <label style="display:inline-block;">Rahmenmaterial<br />
            <select name="frame_material" style="width: 297px">
                <option><?php echo e($item->frame_material) ?></option>
                <option>-------------------------------------</option>
        ...
        <label style="display:inline-block;margin-left:15px;">Rahmenform<br />
            <select name="frame_shape" class="m">
                <option><?php echo e($item->frame_shape) ?></option>
                <option>-----------------------------------</option>
                <option>Diamant</option>
        ...
        <label style="display:inline-block;">Rahmenhöhe<br />
            <input name="frame_height" type="text" class="m" placeholder="in cm" value="<?php echo e($item->frame_height) ?>">
        </label>

        <label style="display:inline-block;margin-left:15px">Laufradgröße<br />
            <select name="wheel_size" class="m">
                <option><?php echo e($item->wheel_size) ?></option>
                <option>-----------------------------------</option>
                <option>12"</option>
                <option>14"</option>
                <option>16"</option>
        ...
        <label style="display:inline-block;">Federweg<br />
            <input name="spring_travel" type="text" class="m" placeholder="in mm" value="<?php echo e($item->spring_travel) ?>">
        </label>

        <label style="display:inline-block;margin-left:15px;">Federung<br />
            <select name="spring" class="m">
                <option><?php echo e($item->spring) ?></option>
                <option>-----------------------------------</option>
        ...
        <label style="display:inline-block;">Gewicht<br />
            <input name="weight" type="text" class="m" placeholder="in kg" value="<?php echo e($item->weight) ?>">
        </label>

        <label style="display:inline-block;margin-left:15px;">Farbe<br />
            <select name="color" class="m">
                <option><?php echo e($item->color) ?></option>
                <option>-----------------------------------</option>
        ...
        <label style="display:inline-block;">Bremse<br />
            <select name="brake" style="width: 297px">
                <option><?php echo e($item->brake) ?></option>
                <option>-------------------------------------</option>
        ...
        <label style="display:inline-block;margin-left:15px;">Motor<br />
            <select name="engine" class="m">
                <option><?php echo e($item->engine) ?></option>
                <option>-----------------------------------</option>
                <option>AEG</option>
